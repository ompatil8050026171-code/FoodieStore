...
<style>
/* ==========================================================================
   REGISTER.CSS - FULL PAGE 50/50 SPLIT SCREEN LAYOUT
   Matches home, menu, order, orderDetails, orderHistory & profile themes
   ========================================================================== */
...
/* ===== RIGHT FORM SECTION (Full Height Scrollable) ===== */
.register-form-right {
    flex: 1;
    padding: 60px 80px;
    display: flex;
...
<head>
    ...
    <title>Create Account | Foodie Store</title>
...
<div class="page-wrapper">
    ...
    <div class="split-card">
        ...
        <!-- LEFT HERO SECTION (Burgers & Fries Image) -->
        <div class="register-hero-left">
            ...
            <div class="hero-content-bottom">
                <h2 class="hero-title">
                    Savor The <span>Crispiest</span> Flavor & Speed ⚡
                </h2>
                <p class="hero-subtitle">
                    Order juicy gourmet burgers, golden fries, and chef specials delivered hot straight to your doorstep.
                </p>

                <div class="feature-chips">
                    <div class="chip">⚡ 20-Min Fast Delivery</div>
                    <div class="chip gold">🔥 30% OFF First Order</div>
                    <div class="chip">⭐ 4.9 Super Rated</div>
                </div>
            </div>
        </div>
        ...
        <div class="register-form-right">
            ...
            <div class="form-header">
                ...
                <p class="subtitle">
                    Join Foodie Store & start your delicious journey 🍕
                </p>
            </div>
            ...
            <form action="register" method="post">
                ...
                <div class="input-group">
                    ...
                    <textarea id="address" name="address" rows="2" placeholder="Your delivery address..." required></textarea>
                </div>
